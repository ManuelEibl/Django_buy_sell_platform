    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, default='No Category Listed', max_length=64)),
                ('created', models.DateField()),
                ('starting_price', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=6)),
                ('current_price', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Bids', to='auctions.listing')),
